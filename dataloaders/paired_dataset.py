...
class PairedCaptionDataset(data.Dataset):
    def __init__(
        ...
        # file_name = "lr_paths.txt"
        # with open(file_name, "w") as file:
        #     for tag_path in self.lr_list:
        #         file.write(tag_path + "\n")
        # print(f"文件已保存为 {file_name}")
        
        # file_name = "gt_paths.txt"
        # with open(file_name, "w") as file:
        #     for tag_path in self.gt_list:
        #         file.write(tag_path + "\n")
        # print(f"文件已保存为 {file_name}")
        
        # file_name = "tag_paths.txt"
        # with open(file_name, "w") as file:
        #     for tag_path in self.tag_path_list:
        #         file.write(tag_path + "\n")
        # print(f"文件已保存为 {file_name}")
    ...
    def __getitem__(self, index):
        ...
        if random.random() < self.null_text_ratio:
            ...
            # print(lq_path,gt_path,tag_path)
