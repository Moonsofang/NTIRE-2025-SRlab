                    ...
                    for row in range(grid_rows):
                        ...
                        for col in range(grid_cols):
                            ...
                            if len(input_list) == batch_size or col == grid_cols-1:
                                ...
                                # print(input_list_t.shape, cond_list_t.shape, img_list_t.shape)[2, 4, 96, 96], [2, 4, 96, 96], [2, 3, 768, 768]
                                # print(ram_encoder_hidden_states.shape)#2, 145, 51
                                ...
                                # print(down_block_res_samples[0].shape,down_block_res_samples[1].shape,down_block_res_samples[2].shape,down_block_res_samples[3].shape,down_block_res_samples[4].shape,down_block_res_samples[5].shape,down_block_res_samples[6].shape,down_block_res_samples[7].shape,down_block_res_samples[8].shape,down_block_res_samples[9].shape,down_block_res_samples[10].shape,down_block_res_samples[11].shape)
