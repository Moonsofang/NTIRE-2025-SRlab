...
def load_seesr_pipeline(args, accelerator, enable_xformers_memory_efficient_attention):
    ...
    # unet = UNet2DConditionModel.from_pretrained(args.seesr_model_path, subfolder="unet",ignore_mismatched_sizes=True,low_cpu_mem_usage=False)
    # controlnet = ControlNetModel.from_pretrained(args.seesr_model_path, subfolder="controlnet",ignore_mismatched_sizes=True,low_cpu_mem_usage=False)
